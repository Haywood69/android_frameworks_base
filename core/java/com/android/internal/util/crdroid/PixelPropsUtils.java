...
public class PixelPropsUtils {
    ...
    static {
        ...
        propsToChangePixel5.put("DEVICE", "husky");
        propsToChangePixel5.put("PRODUCT", "husky");
        propsToChangePixel5.put("HARDWARE", "husky");
        propsToChangePixel5.put("MODEL", "Pixel 8 Pro");
        propsToChangePixel5.put("ID", "UQ1A.240105.004");
        propsToChangePixel5.put("FINGERPRINT", "google/husky/husky:14/UQ1A.240105.004/11206848:user/release-keys");
